    ...
    <div className="h-screen max-sm:h-screen max-sm:w-full bg-green-100 max-sm:bg-green-100">
    {
      ...
      <div className="flex">
        ...
        <div className="flex max-sm:flex-col max-sm:gap-25 items-center justify-center ml-10 h-[75vh] overflow-hidden w-[65vw] max-sm:w-[80vw] max-sm:h-[65vh]">
         <div className=" max-sm:bg-black flex items-center justify-center h-[20vh] w-full">
        ...
        <div className="mt-5 ml-40 max-sm:ml-30 w-[20vw] max-sm:w-[50vw] flex items-center justify-between">
         ...
         <button className="h-16 w-24 max-sm:flex items-center justify-center outline-none rounded-full hover:cursor-pointer bg-black text-white max-sm:text-[4vw] max-sm:h-20 hidden" onClick={() => setUserConnected(true)}><RiMessageLine /></button>
        </div>
        </div>
